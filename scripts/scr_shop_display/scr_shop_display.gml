...
var shift = keyboard_check(vk_shift);
	...
	if (item !=-1) and ((slot < 16)){ // If slots are within 16
	...
	if rightclick  and item != -1  and o_mouse_pointer.sellmode = false {
		...
		// Click Slots		
		if slot >= 0  and slot <= 15 {
			script_execute(scr_buy_item_script);		
		} 
