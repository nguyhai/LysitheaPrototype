...
if global.inventory[63, 33] != -1 {
	dex = o_player_stats.stats[? "dexterity"] + scr_calc_equip_dex()- global.inventory[63, 33]+ argument1; 
} else {
	dex = o_player_stats.stats[? "dexterity"] + scr_calc_equip_dex() + argument1; 
}
