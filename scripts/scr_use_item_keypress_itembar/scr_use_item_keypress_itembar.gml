...
if name = "Health Potion" and o_item_cooldown.hp_potion = 3600 {
	...
	if o_player_stats.stats[? "health"] < o_player_stats.stats[? "maxhealth"] {
		...
		global.itembar[argument0+1, 9] = global.itembar[argument0+1, 9] - 1;
		
		if global.itembar[argument0+1, 9] < 1 {	
			scr_clear_itembar_slot_keypress(argument0);
		}
