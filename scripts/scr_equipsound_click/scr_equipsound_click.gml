...
if item != -1 {
	...
	if type == "Potion" {
		audio_play_sound(snd_potion, 9, false);
	}
	
	if type == "Crafting" {
		audio_play_sound(snd_crafting, 9, false);
	}
