...
int = o_player_stats.stats[? "intelligence"] + scr_calc_equip_intel()- global.inventory[63, 34]+ argument1; 

if global.inventory[63, 34] != -1 {
	int = o_player_stats.stats[? "intelligence"] + scr_calc_equip_intel()- global.inventory[63, 34]+ argument1; 
} else {
	int = o_player_stats.stats[? "intelligence"] + scr_calc_equip_intel() + argument1; 
}
